...
export function calculatePropertyBonuses(
  ...
  return {
    ...
    missionSuccessBonus: alignment === 'GOOD' ? factor * 0.03 : 0,
    missionGoldMultiplier: alignment === 'EVIL' ? 1 + factor * 0.09 : 1,
    itemRewardChanceBonus: alignment === 'EVIL' ? factor * 0.012 : 0,
