...
export const TAVERN_ENEMIES: Record<string, TavernEnemyDefinition[]> = {
  ...
  'vael-courier': [
    {
      ...
      uniqueDetail: 'Nie ma lewej dłoni, ale zapieczętowany list pozostaje zaciśnięty w niewidzialnym chwycie.',
  ...
  'white-moth-hunter': [
    {
      key: 'moth-mercenary', name: 'Varek Bez Chorągwi', title: 'Łowca reliktów',
      family: 'HUMAN', familyLabel: 'Ludzcy Wrogowie', form: 'Najemnik Wolnych Chorągwi', rank: 'ELITE',
      formerPurpose: 'Zwiadowca Bractwa Białej Ćmy wysyłany po relikty z miejsc dotkniętych Wytarciem.',
      ...
      silhouette: 'Szczupły łowca w warstwowej skórzni, z krótkim płaszczem i dwoma wąskimi ostrzami.',
      uniqueDetail: 'Przed odpowiedzią dotyka srebrnej ćmy przyszytej od wewnętrznej strony rękawicy.',
      description: 'Nie pyta, czy cel jest winny. Pyta, czy pamięć zleceniodawcy wytrzyma próbę srebra.',
      ...
      signature: {
        ...
        counterplay: 'Odczytanie szyfru Białej Ćmy ujawnia znaki używane przez jego dawny oddział.',
        modifiers: { hitChanceModifier: 0.03, criticalChanceModifier: 0.025 },
        counteredBy: { puzzleKeys: ['moth-cipher'] },
      },
      visualDirection: { scale: 'atletyczny człowiek', palette: 'czarna skóra, stare srebro, przygaszony błękit', materials: 'skórznia, srebrne nici, krótkie ostrza', composition: 'czujna poza trzy czwarte, jedna dłoń przy ukrytym sztylecie' },
    },
    {
      key: 'moth-revenant', name: 'Morvath, Ostatni Rycerz Białej Ćmy', title: 'Przysięga ruin',
      family: 'AWAKENED_GUARDIAN', familyLabel: 'Przebudzeni Strażnicy', form: 'Pusta zbroja badacza', rank: 'BOSS',
      formerPurpose: 'Rycerz Bractwa pilnujący badaczy podczas pierwszej wyprawy do kopalni aeterytu.',
      fractureEffect: 'Oddał własne wspomnienia pieczęci, aby zatrzymać Wytarcie oddziału; zbroja zachowała sam obowiązek ochrony.',
      silhouette: 'Smukły czarny rycerz z płaszczem rozciętym na dwa skrzydła przypominające ćmę.',
      uniqueDetail: 'Na wewnętrznej stronie tarczy pojawiają się twarze ludzi, których nie zdołał ocalić.',
      description: 'Pancerz nosi znak Bractwa, ale pod przyłbicą pozostała wyłącznie przysięga złożona ruinom.',
      ...
      signature: {
        ...
        counterplay: 'Szyfr Bractwa pozwala wypowiedzieć imiona oddziału i rozluźnić przysięgę.',
        modifiers: { parryChanceModifier: 0.04, criticalResistanceModifier: 0.04 },
        counteredBy: { puzzleKeys: ['moth-cipher'] },
      },
      visualDirection: { scale: 'wysoki smukły rycerz', palette: 'grafit, srebro, blady błękit', materials: 'czerniona płyta, jedwabny płaszcz, srebrne pieczęcie', composition: 'symetryczna garda, płaszcz układający się jak skrzydła ćmy' },
    },
  ],
  'raven-tithe': [
    {
